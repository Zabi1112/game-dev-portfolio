        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              title="Gnome Wars"
              description="It’s a Webgl Game. It is a multiplayer shooting game with a unique concept in which player
               and ai characters are gnomes. As a game developer i worked in this game fetching data from API,
                Multiplayer functionality, Game Play Look and Feel, Game Modes, Google SSO, Twitter SSO
"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              title="Phonics Zoom"
              description="Its a 2d Learning App with multiple mini games in it.
               It is a client game for his school in which we made different games to teach students spelling paragraph
                ...
                lists and also i posts the result of the students back to portal."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              title="Moon Karts"
              description="It’s a WebGL Game for a client which will be uploaded on a metaverse named as
              ...
              and multiplayer work and its smoothness. I also integrate the sso system by building js
               libraries in unity. Also the app is deployed for mobile.
"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              title="AI Layer Moba"
              description="It’s a WebGL Game. It's  just a game in progress right now.
...
"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="It is a single player game of horse racing in which you have to take care of horse maintain his health and make him ready for the races"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              title="Vampire Fall"
              description="It is a single Player game in vampire attacks the player and player has to defend himself in it "
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="It is a 2d Builder game in which user manages a farm have in apps sell products and make his farm some top level.
               leader board and many more apis"
              // ghLink="https://github.com/soumyajit4419/Face_And_Emotion_Detection"
              // demoLink="https://blogs.soumya-jit.tech/"      <--------Please include a demo link here
            />
          </Col>
